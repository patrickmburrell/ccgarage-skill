---
name: cc:remove
description: Uninstall marketplace plugin
---

# `/cc remove <plugin-name[@source]>`

Uninstalls a marketplace plugin. Marketplace plugins only — refuses custom skills.
...
**Output:**
- Error if trying to remove custom skill (clear message)
- Confirmation prompts before acting
- Success message with cache cleanup status
