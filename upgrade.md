---
name: cc:upgrade
description: Update plugins to latest
---

# `/cc upgrade [plugin-name]`

Updates outdated plugins to marketplace HEAD. No args = upgrade all.
...
**Output:**
- For each plugin: "Upgrading X... ✓ updated to <sha>"
- Skips already-current plugins with message
