---
name: cc:info
description: Details about plugin or skill
---

# `/cc info <name>`

Shows details about a specific plugin or skill.
...
```
Marketplace Plugin: superpowers

Version:       98c01d3 (full: 98c01d3a...)
Installed:     2026-04-01T10:23:45Z
Status:        enabled
Cache path:    ~/.claude/plugins/cache/superpowers
✓ Up to date
```
...
Description:   Personal blog management
Path:          ~/.claude/skills/pblog
Last modified: 2026-04-09 14:23
Has evals:     yes (3)
Has reference: yes
```
