---
name: cc:cleanup
description: Act on problems (tiered safety)
---

# `/cc cleanup [--dry-run]`

Acts on problems found by doctor. Tiered safety model.
...
**Output:**
- Auto section: Reports orphaned caches and empty dirs, removes them
- Interactive section: Prompts for each bloated/stale memory, settings.json cleanup
