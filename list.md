---
name: cc:list
description: Show installed plugins and custom skills
---

# `/cc list [plugins|skills]`

Shows everything installed, both ecosystems clearly labeled. Optional filter.
...
**Output:**
```
Marketplace Plugins (9 installed)
  superpowers          98c01d3      updated 2026-04-01
  feature-dev          98c01d3      updated 2026-04-09
  ...

Custom Skills (7 installed)
  pblog                modified 2026-04-09
  daisy                modified 2026-03-27
  ...
```
